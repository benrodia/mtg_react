...
export default connect(({settings})=>settings,actions)
(({
	userName,
	gameLog,
	scale,
	...
	const showSub = 
		<div className="setting-check-box">
			<button className={`smaller-button ${showSubTitle&&'selected'}`} onClick={_=>changeSettings('showSubTitle',!showSubTitle)}>
			Deck Subtitle
			</button>
		</div>
